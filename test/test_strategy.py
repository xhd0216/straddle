...
def validate_strike(o):
  ...
  assert d['is_call'] == o.isCall()
  assert d['expiration'] == o.getExpirationStr(format_str='%Y-%m-%d')

json1 = '{"strike": 132.5, "underlying": "AAPL", "is_call": true, "expiration": "Dec 11, 2045", "price": 128.31}'
...
def test_getStrategyName():
  strike1 = create_strike(None, underlying='aapl', strike=50.0, expiration=datetime.datetime.strptime("Dec 17, 2017", "%b %d, %Y"), is_call=True, price=57.21)
  strike2 = create_strike(None, underlying='aapl', strike=50.0, expiration=datetime.datetime.strptime("Dec 17, 2017", "%b %d, %Y"), is_call=False, price=57.21) 
